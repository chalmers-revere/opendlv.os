...
# USB camera support
./scripts/config -e USB_GADGET -e USB_CONFIGFS -e MEDIA_SUPPORT -e MEDIA_CAMERA_SUPPORT -e MEDIA_USB_SUPPORT -e USB_VIDEO_CLASS -d USB_GSPCA -e USB_VIDEO_CLASS_INPUT_EVDEV
